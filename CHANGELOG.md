...
- `cli`: `--comment` flag for `mcc verify-pr` — posts (or updates) a summary comment on the GitHub PR
- `cli`: improved PR comment format with progress bar, human-friendly status labels, line ranges for uncovered lines, and linked commit SHA
...
[Unreleased]: https://github.com/EmanueleMinotto/manual-code-coverage/compare/v0.2.0...HEAD
[0.2.0]: https://github.com/EmanueleMinotto/manual-code-coverage/compare/v0.1.2...v0.2.0
